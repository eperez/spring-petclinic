# Multiuser issue tracker Sample Application
...
In its default configuration, it uses an in-memory database (HSQLDB) which
...
```
docker run -e MYSQL_ROOT_PASSWORD=issuetracker -e MYSQL_DATABASE=issuetracker -p 3306:3306 mysql:5.7.8
```
